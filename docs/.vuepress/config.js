...
const react_basics_collection = require("./menuConfig/sidebars/react/react_basics");
const vue_basics_collection = require("./menuConfig/sidebars/vue/vue_basics");
const node_basics_collection = require("./menuConfig/sidebars/node/node_basics");
const webpack_collection = require("./menuConfig/sidebars/build/build");

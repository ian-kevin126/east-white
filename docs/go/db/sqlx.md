...
func InitMysql() (err error) {
	...
	dsn := "root:123456@tcp(127.0.0.1:3306)/gin_demo?charset=utf8mb4&parseTime=True"
...
func main() {
	...
	}(db) // 注意这行代码要写在err判断的下面，确保是在err出现之后才去关闭连接
...
- [sqlx使用指南](https://www.liwenzhou.com/posts/Go/sqlx/)